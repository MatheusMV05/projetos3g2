...
public class RelatorioPdfService {
    ...
    /**
     * Gera um relatório PDF de métricas com base nos filtros fornecidos
     *
     * @param filtro filtros para as métricas
     * @return Stream do arquivo PDF gerado
     */
    @Transactional(readOnly = true)
    public ByteArrayInputStream gerarRelatorioPdf(MetricaFiltroDTO filtro) {
        // Buscar métricas com os filtros aplicados
    ...
    /**
     * Prepara os dados do relatório com base nas métricas encontradas
     */
    ...
    /**
     * Constrói uma descrição textual dos filtros aplicados
     */
    ...
    /**
     * Gera o PDF baseado nos dados do relatório
     */
    private ByteArrayInputStream gerarPdf(RelatorioMetricaDTO relatorio) {
        ...
        try {
            ...
            Font subtituloFont = FontFactory.getFont(FontFactory.HELVETICA, 12, BaseColor.BLACK);
    ...
    private void addTableHeader(PdfPTable table) {
        ...
        Stream.of("Nome", "Valor", "Descrição", "Data Referência")
                .forEach(columnTitle -> {
                    ...
                    header.setBackgroundColor(new BaseColor(30, 65, 160));
    ...
    /**
     * Classe interna para cabeçalho e rodapé do PDF
     */
